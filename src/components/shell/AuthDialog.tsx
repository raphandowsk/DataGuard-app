...
export function AuthDialog() {
  ...
  return (
    <div className="fixed inset-0 z-[96] flex items-start justify-center overflow-y-auto bg-[rgba(14,26,28,0.32)] p-6 pt-[6vh] sm:items-center sm:pt-6" onClick={() => setOpen(false)}>
      <div
        role="dialog"
        aria-modal="true"
